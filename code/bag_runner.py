...
parser.add_argument('--epoch', type=int, default=5, help='number of epochs in this run')
...
parser.add_argument('--bag_num',type=int,default=1, help='number of bags per batch')
parser.add_argument('--L',type=int, default=240, help='maximum sentence length')
...
parser.add_argument('--cat_n',type=int,default=50, help='number of relations (including NA, NA is cat<0>)')
parser.add_argument('--cell_type',choices=['lstm','gru','pcnn'],default='pcnn')
...
parser.add_argument('--dataset', choices=['naacl','nyt','kaist'], default='kaist')
...
if args.dataset == 'naacl':
    loader = Loader(relation_file = '../data/relation_dict.pkl',
                    ...
                    embed_dir = '../data/vector_np_200d.pkl',
                    word_dir = args.dict,
    ...
    loader = Loader(relation_file='../data/kaist/relation_dict.pkl',
                    label_data_file=['../data/kaist/crowd_gi.pkl', '../data/kaist/crowd_agreement.pkl'],
                    unlabel_data_file='../data/kaist/DS_noise.pkl',
                    group_eval_data_file='../data/kaist/tta_answer_76.pkl',
                    # embed_dir='../data/kaist/embedding/fasttext/vector_np_100d_wikipedia.pkl',
                    word_dir='../data/kaist/embedding/elmo/elmo_dict.pkl',
                    n_vocab=1500000,
                    valid_split=args.test_split,
                    max_len=args.L,
                    use_DS_data=args.dsdata)
